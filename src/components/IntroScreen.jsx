                ...
                >
                    ...
                    {/* Content layer — scales the 1440×900 design to fit while
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.96 }}
                            onClick={startGame}
                            className="absolute left-[1500px] top-[690px] w-[320px] h-[80px] rounded-[50px] bg-[#20A619] cursor-pointer flex items-center justify-center border border-white/30 shadow-[0_0_20px_rgba(32,166,25,0.6)] hover:shadow-[0_0_35px_rgba(32,166,25,0.9)] transition-all z-20 group"
                        >
                            <span
